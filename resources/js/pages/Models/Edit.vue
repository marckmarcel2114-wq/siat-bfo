...
const form = useForm({
    ...
    marca_id: props.model.marca_id.toString(),
    tipo_activo_id: props.model.tipo_activo_id?.toString() || null,
});
        ...
        <div class="max-w-2xl mx-auto p-4 md:p-8">
            <div class="mb-8">
                ...
                <div class="flex items-center gap-4">
                    ...
                    <div>
                        <h1 class="text-3xl font-extrabold tracking-tight text-foreground">Editar Modelo</h1>
                        <p class="text-muted-foreground">Modifique los datos del modelo existente.</p>
                    </div>
                </div>
            </div>
