        ...
        <div class="max-w-2xl mx-auto p-4 md:p-8">
            <div class="mb-8">
                ...
                <div class="flex items-center gap-4">
                    ...
                    <div>
                        <h1 class="text-3xl font-extrabold tracking-tight text-foreground">Editar Marca</h1>
                        <p class="text-muted-foreground">Actualice el nombre de la marca.</p>
                    </div>
                </div>
            </div>
