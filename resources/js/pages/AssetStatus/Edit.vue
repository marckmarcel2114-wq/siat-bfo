...
const form = useForm({
    nombre: props.status.nombre,
});

const submit = () => {
    form.put(route('asset-status.update', props.status.id));
};
        ...
        <div class="max-w-2xl mx-auto p-4 md:p-8">
            <div class="mb-8">
                ...
                <div class="flex items-center gap-4">
                    ...
                    <div>
                        <h1 class="text-3xl font-extrabold tracking-tight text-foreground">Editar Estado</h1>
                        <p class="text-muted-foreground">Actualice el nombre del estado.</p>
                    </div>
                </div>
            </div>
