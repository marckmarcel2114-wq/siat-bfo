...
const submit = () => {
    form.post(route('criticality.store'));
};
...
<template>
    <AppLayout :breadcrumbs="breadcrumbs">
        <Head title="Nuevo Nivel de Criticidad" />
        ...
        <div class="max-w-2xl mx-auto p-4 md:p-8">
            <div class="mb-8">
                ...
                <div class="flex items-center gap-4">
                    ...
                    <div>
                        <h1 class="text-3xl font-extrabold tracking-tight text-foreground">Nuevo Nivel</h1>
                        <p class="text-muted-foreground">Defina un nuevo nivel de importancia o riesgo.</p>
                    </div>
                </div>
            </div>
                ...
                <form @submit.prevent="submit">
                    ...
                    <CardFooter class="flex justify-end gap-3 border-t border-border/50 bg-muted/10 px-6 py-4">
                        ...
                        >
                            ...
                            {{ form.processing ? 'Guardando...' : 'Guardar Nivel' }}
                        </Button>
                    </CardFooter>
                </form>
            </Card>
