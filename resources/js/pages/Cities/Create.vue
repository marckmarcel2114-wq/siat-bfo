        ...
        <div class="max-w-xl mx-auto p-4 md:p-8">
            <div class="mb-8">
                ...
                <div class="flex items-center gap-4">
                    ...
                    <div>
                        <h1 class="text-3xl font-extrabold tracking-tight text-foreground">Nueva Ciudad</h1>
                        <p class="text-muted-foreground">Registra una nueva ubicación geográfica en el sistema.</p>
                    </div>
                </div>
            </div>
            ...
            <Card class="border-border/60 shadow-xl shadow-primary/5 bg-card/50 backdrop-blur-sm overflow-hidden">
                <form @submit.prevent="submit">
                    <CardHeader class="border-b border-border/50 bg-muted/20 pb-6">
                        ...
                        <CardDescription>Ingrese el nombre oficial y el código referencial de la ciudad.</CardDescription>
                    </CardHeader>
                    ...
                    <CardFooter class="flex justify-end gap-3 border-t border-border/50 bg-muted/10 px-6 py-4">
                        ...
                        >
                            ...
                            {{ form.processing ? 'Guardando...' : 'Guardar Ciudad' }}
                        </Button>
                    </CardFooter>
                </form>
            </Card>
