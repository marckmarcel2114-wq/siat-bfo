...
const submit = () => {
    form.post(route('job-titles.store'), {
        ...
        <div class="max-w-2xl mx-auto p-4 md:p-8">
            <div class="mb-8">
                ...
                <div class="flex items-center gap-4">
                    ...
                    <div>
                        <h1 class="text-3xl font-extrabold tracking-tight text-foreground">Nuevo Cargo</h1>
                        <p class="text-muted-foreground">Registre un nuevo cargo o puesto laboral en el sistema.</p>
                    </div>
                </div>
            </div>
                ...
                <form @submit.prevent="submit">
                    ...
                    <CardContent class="p-6 space-y-6">
                        <div class="space-y-2">
                            ...
                            <Input 
                                ...
                                placeholder="Ej: GERENTE GENERAL, EJECUTIVO DE VENTAS..."
                            />
                    ...
                    <CardFooter class="flex justify-end gap-3 border-t border-border/50 bg-muted/10 px-6 py-4">
                        ...
                        >
                            ...
                            {{ form.processing ? 'Guardando...' : 'Guardar Cargo' }}
                        </Button>
                    </CardFooter>
                </form>
            </Card>
